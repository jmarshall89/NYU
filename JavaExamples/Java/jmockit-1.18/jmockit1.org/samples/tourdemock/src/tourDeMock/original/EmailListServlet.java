...
public final class EmailListServlet extends HttpServlet
{
   ...
   private tourDeMock.original.service.EmailListService emailListService;

   @Override
   public void init() throws ServletException
   {
      emailListService = (tourDeMock.original.service.EmailListService) getServletContext().getAttribute(EmailListService.KEY);
